...
const Search = () => {
    ...
    const zomatologo = "https://miro.medium.com/max/1200/1*AmR7r3OMv55CMB1h4Z2Hrg.jpeg"
    ...
    return (
        <>
            ...
            <section className='iteam_section mt-4 container'>
                <h2 className='px-4' style={{ fontWeight: 400 }}>Restaurants in Chennai Open now</h2>
